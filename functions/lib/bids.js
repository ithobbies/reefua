...
exports.getMyBids = exports.placeBid = void 0;
 ...
 */
exports.placeBid = functions.region('us-central1').https.onCall(async (data, context) => {
    if (!context.auth) {
 ...
 */
exports.getMyBids = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
