...
function AuctionsPageContent() {
    ...
    const [saleTypeFilter, setSaleTypeFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [pageTitle, setPageTitle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Всі активні лоти');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuctionsPageContent.useEffect": ()=>{
            document.title = searchQuery ? `Результати пошуку: ${searchQuery}` : 'Всі лоти - ReefUA';
            const fetchLots = {
                "AuctionsPageContent.useEffect.fetchLots": async ()=>{
                    setLoading(true);
                    try {
                        let lotsList = [];
                        if (searchQuery) {
                            setPageTitle(`Результати пошуку для: "${searchQuery}"`);
                            const searchLotsFunc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$functions$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["httpsCallable"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["functions"], 'searchLots');
                            ...
                            lotsList = lotSnapshot.docs.map({
                                "AuctionsPageContent.useEffect.fetchLots": (doc)=>({
                                        ...doc.data(),
                                        id: doc.id
                                    })
                            }["AuctionsPageContent.useEffect.fetchLots"]);
                        }
                        setLots(lotsList);
                    } catch (error) {
            ...
            const fetchCategories = {
                "AuctionsPageContent.useEffect.fetchCategories": async ()=>{
                    try {
                        ...
                        const categorySnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(categoriesCollection);
                        const categoriesList = categorySnapshot.docs.map({
                            "AuctionsPageContent.useEffect.fetchCategories.categoriesList": (doc)=>doc.data().name
                        }["AuctionsPageContent.useEffect.fetchCategories.categoriesList"]);
                        setCategories(categoriesList);
                    } catch (error) {
                        console.error("Error fetching categories: ", error);
                    }
                }
            }["AuctionsPageContent.useEffect.fetchCategories"];
            fetchLots();
            fetchCategories();
        }
    }["AuctionsPageContent.useEffect"], [
    ...
    const filteredLots = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuctionsPageContent.useMemo[filteredLots]": ()=>{
            return lots.filter({
                "AuctionsPageContent.useMemo[filteredLots]": (lot)=>{
    ...
    const renderLots = (lotsToRender)=>loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            lineNumber: 96,
            columnNumber: 9
        }, this) : lotsToRender.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AuctionsPageContent, "hdrHilE7dMQnHlZMksnKnyaFlEg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
});
_c = AuctionsPageContent;
function AuctionsPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuctionsPageContent, {}, void 0, false, {
            fileName: "[project]/src/app/auctions/page.tsx",
            lineNumber: 160,
            columnNumber: 13
        }, this)
...
_c1 = AuctionsPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "AuctionsPageContent");
__turbopack_context__.k.register(_c1, "AuctionsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_dd157c1c._.js.map