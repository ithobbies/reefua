...
function DashboardLotsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardLotsPage.useEffect": ()=>{
            ...
            if (user) {
                const fetchUserLots = {
                    "DashboardLotsPage.useEffect.fetchUserLots": async ()=>{
                        try {
                            ...
                            const userLots = lotSnapshot.docs.map({
                                "DashboardLotsPage.useEffect.fetchUserLots.userLots": (doc)=>({
                                        ...doc.data(),
                                        id: doc.id
                                    })
                            }["DashboardLotsPage.useEffect.fetchUserLots.userLots"]);
                            setLots(userLots);
                        } catch (error) {
                ...
                }["DashboardLotsPage.useEffect.fetchUserLots"];
                fetchUserLots();
            } else if (!authLoading) {
...
_s(DashboardLotsPage, "N6wtFtr+0PgV3kQfPLl9osErfy0=", false, function() {
    return [
...
//# sourceMappingURL=_50c2bc13._.js.map