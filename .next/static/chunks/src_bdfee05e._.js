...
function AuctionsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuctionsPage.useEffect": ()=>{
            ...
            const fetchLots = {
                "AuctionsPage.useEffect.fetchLots": async ()=>{
                    setLoading(true);
                    try {
                        ...
                        const queryConstraints = [
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('status', '==', 'active')
                        ];
                        if (saleTypeFilter !== 'all') {
                            queryConstraints.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('type', '==', saleTypeFilter));
                        }
                        q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(lotsCollection, ...queryConstraints, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])('endTime', 'asc'));
                        ...
                        const lotsList = lotSnapshot.docs.map({
                            "AuctionsPage.useEffect.fetchLots.lotsList": (doc)=>({
                                    ...doc.data(),
                                    id: doc.id
                                })
                        }["AuctionsPage.useEffect.fetchLots.lotsList"]);
                        setLots(lotsList);
                        ...
                        const categoriesList = categorySnapshot.docs.map({
                            "AuctionsPage.useEffect.fetchLots.categoriesList": (doc)=>doc.data().name
                        }["AuctionsPage.useEffect.fetchLots.categoriesList"]);
            ...
            }["AuctionsPage.useEffect.fetchLots"];
            fetchLots();
        }
    }["AuctionsPage.useEffect"], [
        saleTypeFilter
    ...
    const filteredLots = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuctionsPage.useMemo[filteredLots]": ()=>{
            return lots.filter({
                "AuctionsPage.useMemo[filteredLots]": (lot)=>{
...
_s(AuctionsPage, "mu7G+r7ZQUfOon/j1HqxUp4RS1g=");
_c = AuctionsPage;
var _c;
...
//# sourceMappingURL=src_bdfee05e._.js.map