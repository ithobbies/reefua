...
const categoryColorMap = {
    // Main Categories
    livestock: 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300',
    corals: 'bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-300',
    equipment: 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300',
    // Subcategories for Livestock
    fish: 'bg-sky-100 text-sky-800 dark:bg-sky-900 dark:text-sky-300',
    invertebrates: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-300',
    // Subcategories for Corals
    soft: 'bg-pink-100 text-pink-800 dark:bg-pink-900 dark:text-pink-300',
    lps: 'bg-fuchsia-100 text-fuchsia-800 dark:bg-fuchsia-900 dark:text-fuchsia-300',
    sps: 'bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-300',
    anemones: 'bg-rose-100 text-rose-800 dark:bg-rose-900 dark:text-rose-300',
...
"[project]/src/app/lot/[id]/page.tsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/src/app/lot/[id]/page.tsx'
...
//# sourceMappingURL=_53cf68fd._.js.map